...
<!-- <script src="/Public/BJUI/js/jquery-2.2.3.min.js"></script> -->
...
$(function() {
    ...
    $('.delcache').click(function() {
        $.get("<?php echo U('Index/delcache');?>", function(r) {
            if (r.statusCode == 300) {
                $('body').alertmsg('error', r.message, {});
            } else {
                $('body').alertmsg('ok', r.message, {});
            }
        },'json');
    });
...
<body>
    ...
    <header id="bjui-header">
        <div class="bjui-navbar-header">
            ...
            <a class="bjui-navbar-logo" href="#"><img src="/Public/Admin/img/logo.png"></a>
        </div>
        <nav id="bjui-navbar-collapse">
            <ul class="bjui-navbar-right">
                <li class="datetime"><div><span id="bjui-date"></span> <span id="bjui-clock"></span></div></li>
                <li><a href="#">欢迎您: <span class="badge"><?php echo ($nickname); ?></span></a></li>
                <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">我的账户 <span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                        <li>
                            <a href="#" data-toggle="dialog" data-options="{id:'index-changepwd', url:'<?php echo U('changepwd');?>', mask:true, width:500, height:260}">&nbsp;<span class="glyphicon glyphicon-lock"></span> 修改密码&nbsp;
                            </a>
                        </li>
                        <li>
                            <a href="#" data-toggle="dialog" data-options="{id:'index-myinfo', url:'<?php echo U('myinfo');?>', mask:true}">&nbsp;<span class="glyphicon glyphicon-user"></span> 我的资料
                            </a>
                        </li>
                        <li class="divider"></li>
                ...
                <li><a href="javascript:;" class="delcache"><i class="fa fa-leaf"></i>&nbsp;清除缓存</a></li>
        ...
        <div id="bjui-hnav">
            ...
            <div id="bjui-hnav-navbar-box">
                <ul id="bjui-hnav-navbar">
                    ...
                    <?php if(is_array($menuList)): foreach($menuList as $key=>$v): ?><li <?php if($key == 0): ?>class="active"<?php endif; ?>><a href="javascript:;" data-toggle="slidebar"><i class="fa fa-<?php echo ($v["icon"]); ?>"></i> <?php echo ($v["title"]); ?></a>
                        <div class="items hide" data-noinit="true">
                            
                            <?php if(is_array($v["_child"])): foreach($v["_child"] as $key=>$v2): ?><ul class="menu-items" data-tit="<?php echo ($v2["title"]); ?>" data-faicon="<?php echo ($v2["icon"]); ?>">

                                    <?php if(is_array($v2["_child"])): foreach($v2["_child"] as $key=>$v3): ?><li><a href="<?php echo U($v3['name']);?>" data-options="{id:'link<?php echo ($v3["id"]); ?>', faicon:'<?php echo ($v3["icon"]); ?>'}"><?php echo ($v3["title"]); ?></a></li><?php endforeach; endif; ?>
