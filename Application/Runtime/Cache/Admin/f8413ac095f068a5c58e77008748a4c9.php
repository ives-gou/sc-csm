<?php if (!defined('THINK_PATH')) exit();?><div class="bjui-pageHeader" style="background:#FFF;">
    <div style="padding: 0 15px;">
        <h4 style="margin-bottom:20px;">
            SC-CMS (失策内容管理系统)　<small>轻松开发，专注您的业务</small>
        </h4>
...
<div class="bjui-pageContent">
    <div style="margin-top:5px; overflow:hidden;">
        <div class="row" style="padding: 0 8px;">
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading"><h3 class="panel-title">PHP已编译模块</h3></div>
