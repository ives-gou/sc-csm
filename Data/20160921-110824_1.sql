...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='行为日志表';

-- -----------------------------
-- Records of `sc_action_log`
-- -----------------------------
INSERT INTO `sc_action_log` VALUES ('5', '1', '5', '2130706433', 'Manager', '5', '测试1在2016-09-12 16:45登录了后台', '1', '1473669913');
INSERT INTO `sc_action_log` VALUES ('6', '1', '1', '2130706433', 'Manager', '1', '管理员在2016-09-13 09:31登录了后台', '1', '1473730285');
INSERT INTO `sc_action_log` VALUES ('7', '1', '1', '2130706433', 'Manager', '1', '管理员在2016-09-13 09:58登录了后台', '1', '1473731935');
INSERT INTO `sc_action_log` VALUES ('8', '1', '1', '2130706433', 'Manager', '1', '管理员在2016-09-14 09:04登录了后台', '1', '1473815099');
INSERT INTO `sc_action_log` VALUES ('9', '1', '1', '2130706433', 'Manager', '1', '管理员在2016-09-16 08:35登录了后台', '1', '1473986111');
INSERT INTO `sc_action_log` VALUES ('10', '1', '1', '2130706433', 'Manager', '1', '管理员在2016-09-19 10:46登录了后台', '1', '1474253200');
INSERT INTO `sc_action_log` VALUES ('11', '1', '1', '2130706433', 'Manager', '1', '管理员在2016-09-21 09:07登录了后台', '1', '1474420072');
...
-- -----------------------------
INSERT INTO `sc_auth_group` VALUES ('1', '测试', '97', '阿斯顿撒旦', '1', '5,1,2,3,6,7,9,10,11');
...
CREATE TABLE `sc_auth_rule` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='后台菜单表';
...
INSERT INTO `sc_auth_rule` VALUES ('8', '6', 'Admin/Database/import', '还原数据库', '2', '1', '1', 'angle-right', '', '99', '');
...
INSERT INTO `sc_auth_rule` VALUES ('18', '17', 'Admin/Action/index', '用户行为', '2', '1', '1', 'angle-right', '', '99', '');
...
-- -----------------------------
INSERT INTO `sc_manager` VALUES ('1', 'admin', '管理员', 'bf718be634272ecc25bf48246206ba64', '664709989@qq.com', '18281774033', '0', '0', '1474420072', '2130706433', '1473041671', '1');
INSERT INTO `sc_manager` VALUES ('5', 'root', '测试1', 'bf718be634272ecc25bf48246206ba64', '', '', '1472785914', '2130706433', '1473669913', '2130706433', '1473407613', '1');
