...
CREATE TABLE `sc_action` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统行为表';
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='行为日志表';

-- -----------------------------
-- Records of `sc_action_log`
-- -----------------------------
INSERT INTO `sc_action_log` VALUES ('1', '1', '1', '2130706433', 'Manager', '1', '在登录了后台', '1', '1473649534');
INSERT INTO `sc_action_log` VALUES ('3', '1', '5', '2130706433', 'Manager', '5', '测试1在2016-09-12 15:03登录了后台', '1', '1473663805');
...
-- -----------------------------
INSERT INTO `sc_manager` VALUES ('1', 'admin', '管理员', 'bf718be634272ecc25bf48246206ba64', '664709989@qq.com', '18281774033', '0', '0', '1473650156', '2130706433', '1473041671', '1');
INSERT INTO `sc_manager` VALUES ('5', 'root', '测试1', 'bf718be634272ecc25bf48246206ba64', '', '', '1472785914', '2130706433', '1473663805', '2130706433', '1473407613', '1');
