...
body {
    background: url(/Public/Admin/img/loginbg_01.jpg) no-repeat center center fixed;
...
$(function() {
	...
	$("#login_form").submit(function(){
		...
		$.post("<?php echo U('Public/login');?>", data, function(r) {
			if (r.statusCode == 300) {
...
function changeCode(){
	$("#captcha_img").attr("src", "<?php echo U('Public/verify');?>?t="+ Math.random());
}
function choose_bg() {
	var bg = Math.floor(Math.random() * 9 + 1);
	$('body').css('background-image', 'url(/Public/Admin/img/loginbg_0'+ bg +'.jpg)');
}
